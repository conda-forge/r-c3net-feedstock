...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/r-c3net-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=4167&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/r-c3net-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `r-c3net` can be installed with:

```
conda install r-c3net
```

It is possible to list all of the versions of `r-c3net` available on your platform with:
